...
**MVP 1 - Sistema Base (2-3 meses) - OBLIGATORIO**
...
**MVP 2 - Experiencia 3D (3-4 semanas)**
...
**MVP 3 - Realidad Aumentada (1-2 semanas)**
- Botón "Ver en mi mesa" (WebXR / Scene Viewer / Quick Look)
- Rotar, escalar, colocar sobre superficie

**MVP 4 - Agente IA Luna-Worker (2-3 semanas)**
...
**MVP 5 - Analítica Avanzada (2 semanas)**
- Escaneos QR, visitas, producto más visto, visualizaciones 3D, usos AR, conversión vistas->ventas, horas pico
...
### 3.5 Costos de Desarrollo (estimado)
- MVP1: 2-3 meses (1 dev fullstack)
- MVP2+3: 1 mes
- MVP4 (fork Luna): 2-3 semanas
- MVP5: 2 semanas

## 4. Roadmap Recomendado

1. Validar MVP1 con 1-2 restaurantes reales antes de código 3D/IA
2. Cobrar MVP1, financiar 3D con ingresos
3. Fork Luna-Worker con Gemini 2.5 Flash-Lite por defecto
